if(typeof window.mylocalStorage == 'undefined' || typeof window.mysessionStorage == 'undefined')
 (function(){
    var Storage = function(type){
        ...
        if(typeof window.mylocalStorage == 'undefined')
        window.mylocalStorage=new Storage('local')
        if(typeof window.mysessionStorage == 'undefined')
        window.mysessionStorage=new Storage('session')
